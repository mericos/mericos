...
export function Welcome() {
	...
	return (
		<Box width={"full"} align={"center"}>
			<Navbar
				size={size}
				navigationState={"not_authenticated"}
				type="primary"
			/>
				...
				<SimpleGrid spacing={"2"} minChildWidth={"xs"}>
					...
					>
						...
						>
							...
							elit. Commodi veniam minus fugit enim excepturi
							impedit soluta sint eum omnis ea eveniet incidunt,
							nulla totam dolores illo asperiores eaque itaque
							deleniti.
						</Text>
					...
					<Box>
						<Image
							...
							objectFit={"cover"}
							borderRadius={8}
							src="https://b.zmtcdn.com/data/pictures/chains/9/19912889/e9f25f9e9daf2e355e7c44b5877c46ba.jpg?output-format=webp"
						/>
					</Box>
				</SimpleGrid>
