import { Box, Center, Flex, Grid, GridItem, Link, Stack, Text } from "@chakra-ui/react";
				...
				<Center>
					...
					>
						<Stack spacing={"4"}>
							...
							<InputM text={"Email"} />{" "}
							<InputM text={"Passoword"} />{" "}
							<InputM text={"Confirm Password"} />
							<Text
								color="primary.500"
								align={"right"}
								fontSize={"xs"}
							...
							<Text align={"center"} fontSize={"sm"}>
								{" "}
								Já tem uma conta? <Link color={"primary.500"}>Login</Link>
							</Text>
						</Stack>
					</Flex>
				</Center>
